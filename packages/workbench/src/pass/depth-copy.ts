...
import renderFragmentDepthCopy from '@use-gpu/wgsl/render/fragment/depth-copy.wgsl';
import renderFragmentDepthSampleCopy from '@use-gpu/wgsl/render/fragment/depth-sample-copy.wgsl';
