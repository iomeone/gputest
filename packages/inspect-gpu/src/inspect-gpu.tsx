...
import { FiberTag, IconItem, SVGAtom, SVGDashboard, SVGHighlightElement, SVGNextOpen, SVGViewOutput, SVGRaster, SVGCompute, SVGCamera, SVGOther } from '@use-gpu/inspect';
