...
import { FiberTag, IconItem, SVGAtom, SVGDashboard, SVGHighlightElement, SVGNextOpen, SVGViewOutput, SVGRaster, SVGCompute, SVGCamera, SVGData, SVGOther } from '@use-gpu/inspect';
