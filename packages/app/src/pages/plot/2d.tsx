...
import {
  Plot, Cartesian, Axis, Grid, Point, Line, Arrow, Face, Transform, Polygon, Label,
} from '@use-gpu/plot';
import { UI, Layout, Absolute, Inline, Text } from '@use-gpu/layout';
...
export const Plot2DPage: LC = () => {
  ...
  return (<>
    ...
    <Cursor cursor="move" />
    <LinearRGB backgroundColor={[0, 0, .09, 1]}>
      <Camera>
        <Pass>
          <Plot>
            {/* Transforms */}
            <Transform position={[100, 100]}>
              ...
              <Transform position={[300, 700]}>
                <Label
                  ...
                  colors={[[1, 1, 1, 1], [0, 1.0, 0.25, 1], [0.25, 0.5, 1, 1]]}
                  labels={["Hello world", "Hello GPU", "Hello canvas"]}
                  size={16}
                  depth={1}
                  mode="transparent"
              ...
              <Transform position={[400, 700]}>
                <Label
                  positions={[[0, 0], [0, 20], [0, 40]]}
                  colors={[[1, 1, 1, 1], [0, 1.0, 0.25, 1], [0.25, 0.5, 1, 1]]}
                  labels={["Hello world", "Hello GPU", "Hello canvasx"]}
                  size={14}
                  depth={0}
                  mode="transparent"
                  alphaToCoverage={false}
