...
const _ = decompressString("getVertex toColorSpace VertexOutput main ../../../wgsl/use/types SolidVertex ../../../wgsl/use/color premultiply link u32 optional vertex vertexIndex builtin(vertex_index) instanceIndex builtin(instance_index) VertexOutput builtin position location".split(' '));
const table = {[S]:_([0,1,2,3]),[W]:_([3]),[O]:[{[A]:0,[N]:_(4),[S]:_([5]),[K]:[{[N]:_(5),[J]:_(5)}]},{[A]:0,[N]:_(6),[S]:_([7]),[K]:[{[N]:_(7),[J]:_(7)}]}],[X]:[{[A]:100,[R]:_(0),[G]:2,[F]:{[N]:_(0),[T]:_(5),[Z]:_([8]),[P]:[{[N]:"v",[T]:_(9)},{[N]:"i",[T]:_(9)}]}},{[A]:155,[R]:_(1),[G]:6,[F]:{[N]:_(1),[T]:C,[Z]:_([10,8]),[P]:[{[N]:"c",[T]:C}]}}],[E]:[{[A]:451,[R]:_(3),[G]:1,[F]:{[N]:_(3),[T]:_(2),[Z]:_([11]),[P]:[{[N]:_(12),[T]:_(9),[Z]:_([13])},{[N]:_(14),[T]:_(9),[Z]:_([15])}],[I]:_([2,0,2,1])}}],[L]:{[_(0)]:true,[_(1)]:true}};
const data = {
  name: "vertex/virtual-solid.wgsl",
  code: _(["use '",4,"'::{ ",5," };\r\nuse '",6,"'::{ ",7," };\r\n\r\n@",8," fn ",0,"(v: u32, i: u32) -> ",5," {};\r\n@",10," @",8," fn ",1,"(c: ",C,") -> ",C," { return c; }\r\n\r\n",U," ",2," {\r\n  @",17,"(",18,") ",18,": ",C,",\r\n  @",19,"(0) fragColor: ",C,",\r\n  @",19,"(1) fragUV: ",C,",\r\n  @",19,"(2) fragST: ",C,",\r\n  @",19,"(3) fragScissor: ",C,",\r\n};\r\n\r\n@",11,"\r\nfn ",3,"(\r\n  @",17,"(",11,"_index) ",11,"Index: u32,\r\n  @",15," ",14,": u32,\r\n) -> ",2," {\r\n  let v = ",0,"(",11,"Index, ",14,");\r\n\r\n  return ",2,"(\r\n    v.",18,",\r\n    ",1,"(v.color),\r\n    v.uv,\r\n    v.st,\r\n    v.scissor,\r\n  );\r\n}\n"]).join(''),
  hash: 0x17834d28c26932,
  table,
