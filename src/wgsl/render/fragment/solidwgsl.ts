...
const data = {
  ...
  hash: 0x1e38bac5afbba6,
  table,
  shake: [[0,[0,2]],[111,[1,2]],[213,[2]]],
  tree: decompressAST([[4,0,109,0],[1,0,9],[1,10,15],[2,9,20],[4,92,190,1],[1,0,9],[1,10,15],[2,9,19],[0,83,499],[3,0,9],[2,14,18],[3,9,21],[3,38,50],[3,35,47],[3,35,47],[3,43,55],[2,68,79],[2,74,84]], table[S]),
};
