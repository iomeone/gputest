...
const data = {
  name: "wireframe/wireframe-list.wgsl",
  code: _(["use '",3,"'::{ ",4," };\r\nuse '",5,"'::{ ",6," };\r\nuse '",7,"'::{ ",8," };\r\nuse '",9,"'::{ ",10," };\r\nuse '",11,"'::{ ",12," };\r\n\r\n@",13," fn ",0,"(v: u32, i: u32) -> ",4," {};\r\n@",13," fn ",1,"() -> u32 {};\r\n\r\n@",15," fn ",2,"(",16,": u32, ",17,": u32) -> ",4," {\r\n  var ij = ",10,"(",16,");\r\n  var xy = vec2<f32>(ij) * 2.0 - 1.0;\r\n\r\n  var n = ",1,"();\r\n  var f = ",17," % n;\r\n  var i = ",17," / n;\r\n\r\n  var v = u32(f) % 3u;\r\n  var t = u32(f) - v;\r\n\r\n  var ia: u32;\r\n  var ib: u32;\r\n  var ic: u32;\r\n  if (v == 0u) {\r\n    ia = t;\r\n    ib = t + 1u;\r\n    ic = t + 2u;\r\n  }\r\n  else if (v == 1u) {\r\n    ia = t + 1u;\r\n    ib = t + 2u;\r\n    ic = t;\r\n  }\r\n  else if (v == 2u) {\r\n    ia = t + 2u;\r\n    ib = t;\r\n    ic = t + 1u;\r\n  }\r\n\r\n  var a = ",0,"(ia, i);\r\n  var b = ",0,"(ib, i);\r\n  var c = ",0,"(ic, i);\r\n\r\n  if (a.",23,".w < 0.0 || b.",23,".w < 0.0 || c.",23,".w < 0.0) {\r\n    return ",4,"(\r\n      ",C,"(0.0),\r\n      ",C,"(0.0),\r\n      ",C,"(0.0),\r\n      ",C,"(0.0),\r\n      ",C,"(0.0),\r\n      0u,\r\n    );\r\n  }\r\n\r\n  var left  = a.",23,".xyz / a.",23,".w;\r\n  var right = b.",23,".xyz / b.",23,".w;\r\n  var other = c.",23,".xyz / c.",23,".w;\r\n\r\n  let ",24," = ",6,"() * 2.0;\r\n  var join: ",D,";\r\n  if (ij.x > 0u) {\r\n    join = ",12,"(left, right, other, f32(ij.x) - 1.0, xy.y, ",24,", 3, 0);\r\n  }\r\n  else {\r\n    join = ",12,"(other, left, right, 1.0, xy.y, ",24,", 3, 0);\r\n  }\r\n\r\n  return ",4,"(\r\n    ",C,"(join, 1.0),\r\n    ",C,"(1.0),\r\n    ",C,"(0.0),\r\n    ",C,"(0.0),\r\n    ",C,"(1.0),\r\n    0u,\r\n  );\r\n}\n"]).join(''),
  hash: 0x13d8cd831e78d6,
  table,
  shake: [[268,[0,2]],[323,[1,2]],[364,[2]]],
  tree: decompressAST([[1,0,46],[1,49,100],[1,54,105],[1,54,107],[1,56,106],[1,55,107],[1,55,91],[0,41,1517],[1,0,7],[2,11,33],[2,64,75],[2,26,39],[2,80,95],[2,417,426],[2,29,38],[2,29,38],[2,105,116],[2,313,330],[2,83,94],[2,100,111],[2,78,89]], table[S]),
};
