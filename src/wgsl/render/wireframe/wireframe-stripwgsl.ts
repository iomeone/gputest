...
const data = {
  ...
  code: _(["use '",3,"'::{ ",4," };\r\nuse '",5,"'::{ ",6," };\r\nuse '",7,"'::{ ",8," };\r\nuse '",9,"'::{ ",10," };\r\nuse '",11,"'::{ ",12," };\r\n\r\n@",13," fn ",0,"(v: u32, i: u32) -> ",4," {};\r\n@",13," fn ",1,"() -> u32 {};\r\n\r\n@",15," fn ",2,"(",16,": u32, ",17,": u32) -> ",4," {\r\n  var ij = ",8,"(",16,");\r\n  var xy = vec2<f32>(ij) * 2.0 - 1.0;\r\n\r\n  var n = ",1,"();\r\n  var f = ",17," % n;\r\n  var i = ",17," / n;\r\n\r\n  var ",23," = ",10,"(f);\r\n  var edgeIndex = ",23,".y;\r\n  var ",24," = ",23,".x;\r\n\r\n  var a = ",0,"(",24,", i);\r\n  var b = ",0,"(",24," + 1u + edgeIndex, i);\r\n\r\n  var left = a.",25,".xyz / a.",25,".w;\r\n  var right = b.",25,".xyz / b.",25,".w;\r\n\r\n  if (a.",25,".w < 0.0 || b.",25,".w < 0.0) {\r\n    ",26," ",4,"(\r\n      ",C,"(0.0),\r\n      ",C,"(0.0),\r\n      ",C,"(0.0),\r\n      ",C,"(0.0),\r\n      ",C,"(0.0),\r\n      0u,\r\n    );\r\n  }\r\n\r\n  let l = length(left - right);\r\n  if (l == 0.0) {\r\n    ",26," ",4,"(\r\n      ",C,"(0.0),\r\n      ",C,"(1.0),\r\n      ",C,"(0.0),\r\n      ",C,"(0.0),\r\n      ",C,"(1.0),\r\n      0u,\r\n    );\r\n  }\r\n\r\n  let ",27," = ",6,"() * 2.0;\r\n  var join: ",D,";\r\n  if (ij.x > 0u) {\r\n    join = ",12,"(left, left, right, 0.0, xy.y, ",27,", 1, 0);\r\n  }\r\n  else {\r\n    join = ",12,"(left, right, right, 0.0, xy.y, ",27,", 2, 0);\r\n  }\r\n\r\n  ",26," ",4,"(\r\n    ",C,"(join, 1.0),\r\n    ",C,"(1.0),\r\n    ",C,"(0.0),\r\n    ",C,"(0.0),\r\n    ",C,"(1.0),\r\n    0u,\r\n  );\r\n}\n"]).join(''),
  hash: 0x156af20e297439,
  table,
  shake: [[268,[0,2]],[323,[1,2]],[364,[2]]],
  tree: decompressAST([[1,0,46],[1,49,100],[1,54,105],[1,54,107],[1,56,106],[1,55,107],[1,55,91],[0,41,1433],[1,0,7],[2,11,34],[2,65,76],[2,26,38],[2,79,94],[2,101,114],[2,96,105],[2,35,44],[2,199,210],[2,218,229],[2,173,190],[2,83,94],[2,87,98],[2,78,89]], table[S]),
};
