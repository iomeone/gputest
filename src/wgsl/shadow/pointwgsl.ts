...
const data = {
  ...
  hash: 0x18f918ea2f449f,
  table,
  shake: [[117,[0,1]],[214,[1]]],
  tree: decompressAST([[1,0,54],[1,57,112],[4,60,153,0],[1,0,9],[1,10,15],[2,9,21],[0,78,1635],[1,0,7],[2,11,27],[2,28,33],[2,19,34],[2,601,617],[2,257,269],[2,234,246],[2,233,245],[2,120,132]], table[S]),
};
