...
const _ = decompressString("sampleShadow applySpotShadow ../../wgsl/use/types Light SurfaceFragment ../../wgsl/codec/octahedral encodeOctahedral encodeHemiOctahedral f32 optional link vec2<f32> index u32 level export light surface sampleShadow surface shadowBias shadowUV SHADOW_PAGE".split(' '));
