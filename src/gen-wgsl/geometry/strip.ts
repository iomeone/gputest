...
const data = {
    ...
    "table": {"symbols":["getStripIndex","getStripUV"],"visibles":["getStripIndex","getStripUV"],"exports":[{"at":0,"symbol":"getStripIndex","flags":1,"func":{"name":"getStripIndex","type":{"name":"vec2","args":[{"name":"u32"}]},"attributes":[{"name":"export"}],"parameters":[{"name":"vertex","type":{"name":"u32"}}],"identifiers":[]}},{"at":135,"symbol":"getStripUV","flags":1,"func":{"name":"getStripUV","type":{"name":"vec2","args":[{"name":"f32"}]},"attributes":[{"name":"export"}],"parameters":[{"name":"vertex","type":{"name":"u32"}}],"identifiers":["getStripIndex"]}}],"declarations":[{"at":0,"symbol":"getStripIndex","flags":1,"func":{"name":"getStripIndex","type":{"name":"vec2","args":[{"name":"u32"}]},"attributes":[{"name":"export"}],"parameters":[{"name":"vertex","type":{"name":"u32"}}],"identifiers":[]}},{"at":135,"symbol":"getStripUV","flags":1,"func":{"name":"getStripUV","type":{"name":"vec2","args":[{"name":"f32"}]},"attributes":[{"name":"export"}],"parameters":[{"name":"vertex","type":{"name":"u32"}}],"identifiers":["getStripIndex"]}}]},
