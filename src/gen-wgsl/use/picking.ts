...
const data = {
    ...
    "hash": "vq0dmz9ao7",
    "table": {"symbols":["PickingUniforms","pickingUniforms","getPickingColor"],"visibles":["getPickingColor"],"declarations":[{"at":0,"symbol":"PickingUniforms","flags":0,"struct":{"name":"PickingUniforms","members":[{"name":"pickingId","type":{"name":"u32"}}]}},{"at":51,"symbol":"pickingUniforms","flags":0,"variable":{"name":"pickingUniforms","type":{"name":"PickingUniforms"},"attributes":[{"name":"group","args":["PICKING"]},{"name":"binding","args":["PICKING"]}],"identifiers":["PickingUniforms"],"qual":"<uniform>"}},{"at":135,"symbol":"getPickingColor","flags":1,"func":{"name":"getPickingColor","type":{"name":"vec4","args":[{"name":"u32"}]},"attributes":[{"name":"export"}],"parameters":[{"name":"fragIndex","type":{"name":"u32"}}],"identifiers":["pickingUniforms"]}}]},
