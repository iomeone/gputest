...
const data = {
    ...
    "hash": "fzkfl9jqco",
    "table": {"symbols":["getIndex"],"visibles":["getIndex"],"declarations":[{"at":0,"symbol":"getIndex","flags":1,"func":{"name":"getIndex","type":{"name":"void"},"attributes":[{"name":"export"}],"parameters":[{"name":"i","type":{"name":"u32"}}],"identifiers":[]}}]},
    "shake": [[0,["getIndex"]]],
