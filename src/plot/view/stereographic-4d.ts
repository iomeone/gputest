...
export type Stereographic4DProps = TraitProps<typeof Traits> & PropsWithChildren<{
  bend?: number,
  normalize?: number | boolean,
  on?: Axis4,
}>;

export const Stereographic4D: LiveComponent<Stereographic4DProps> = (props: Stereographic4DProps) => {
  const {
    on = 'z',
    bend = 1,
    normalize = 1,
