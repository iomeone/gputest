            ...
            <Plot>
              ...
              >
                <Transform4D matrix={angleToMat4(options.spin1, options.spin2)}>
                  ...
                  <Label color={GREY} size={16} weight="bold" position={[5, 0, 0, 0]} label="X" placement="bottom" offset={[0, 20]} />
                  <Label color={GREY} size={16} weight="bold" position={[0, 5, 0, 0]} label="Y" placement="bottom" offset={[0, 20]} />
                  <Label color={GREY} size={16} weight="bold" position={[0, 0, 5, 0]} label="Z" placement="left" offset={[0, 20]} />
                  <Label color={GREY} size={16} weight="bold" position={[0, 0, 0, 5]} label="W" placement="bottomLeft" offset={[0, 20]} />
