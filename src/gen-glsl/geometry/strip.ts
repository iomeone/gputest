...
const data = {
    ...
    "table": {"hash":"mlfhplj8ee","symbols":["getStripIndex","getStripUV"],"visibles":["getStripIndex","getStripUV"],"functions":[{"at":16,"symbols":["getStripIndex"],"identifiers":[],"flags":1,"prototype":{"name":"getStripIndex","type":{"name":"ivec2","qualifiers":[]},"parameters":["int","vertex"]}},{"at":142,"symbols":["getStripUV"],"identifiers":["getStripIndex"],"flags":1,"prototype":{"name":"getStripUV","type":{"name":"vec2","qualifiers":[]},"parameters":["int","vertex"]}}]},
