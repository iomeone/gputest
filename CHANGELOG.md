...
- `@use-gpu/workbench`: Add `facet` props to distinguish co-planar faces
- `@use-gpu/workbench`: Add `facets` mode to `<Pass>` to render facet info to normal buffer
